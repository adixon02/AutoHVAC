    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="card">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            <h3 className="font-semibold text-gray-800 mb-3">System Recommendation</h3>
            <div className="space-y-2 text-sm">
              ...
              <p><span className="font-medium">Est. Cost:</span> ${hvac_design?.estimated_cost?.toLocaleString() || 'TBD'}</p>
            </div>
          </div>
        </div>
      </div>
