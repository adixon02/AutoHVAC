...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary Brand Colors (Professional Blue - Trust, Reliability)
        primary: {
          50: '#eff6ff',
          100: '#dbeafe', 
          200: '#bfdbfe',
        ...
        // Secondary Colors (Industrial Orange - Action, Energy)
        secondary: {
          50: '#fff7ed',
          100: '#ffedd5',
          200: '#fed7aa',
      ...
      boxShadow: {
        ...
        'medium': '0 4px 25px -2px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)',
        'strong': '0 10px 40px -4px rgba(0, 0, 0, 0.1), 0 4px 25px -5px rgba(0, 0, 0, 0.07)',
      },
      animation: {
