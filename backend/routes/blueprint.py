...
async def upload_blueprint(
    ...
    print(f"▶️ upload hit: filename={file.filename}, size={file.size}, email={email}, project={project_label}, duct={duct_config}, fuel={heating_fuel}")
    ...
    try:
        ...
        print(f"   ▶️ read bytes in main route: {len(file_content)}")
